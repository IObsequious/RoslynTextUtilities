// -----------------------------------------------------------------------
// <copyright file="StringTable.cs" company="Ollon, LLC">
...
namespace System.Text
{
    ...
    public class StringTable
    {
        ...
        private static unsafe string AddSharedSlow(int hashCode, byte* utf8Bytes, int byteCount, bool isAscii)
        {
            ...
            //       The MetadataReader has code to light it up and even fall back to public String.CreateStringFromEncoding
