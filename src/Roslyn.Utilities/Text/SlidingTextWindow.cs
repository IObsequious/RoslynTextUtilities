// -----------------------------------------------------------------------
// <copyright file="SlidingTextWindow.cs" company="Ollon, LLC">
...
namespace Microsoft.CodeAnalysis.Text
{
    ...
    public sealed class SlidingTextWindow : IDisposable
    {
        ...
        //public char ScanUnicodeEscape(bool peek, out char surrogateCharacter, out SyntaxDiagnosticInfo info)
        //{
        //    surrogateCharacter = InvalidCharacter;
        //    info = null;
        ...
        //public SyntaxDiagnosticInfo CreateIllegalEscapeDiagnostic(int start)
        //{
        //    return new SyntaxDiagnosticInfo(start - LexemeStartPosition,
        //        Position - start,
