...
namespace Roslyn.Utilities
{
    public static partial class EnumerableExtensions
    {
            ...
            where T : struct
        {
            ...
            return source.Cast<T?>().FirstOrDefault(predicate: v => predicate(v.Value));
        }
        ...
        public static ImmutableArray<TResult> SelectAsArray<TSource, TResult>(this IEnumerable<TSource> source,
        ...
        public static IEnumerable<T> Flatten<T>(this IEnumerable<IEnumerable<T>> sequence)
        {
            ...
            return sequence.SelectMany(selector: s => s);
        }
